                                ...
                                <table class="table table-white table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Max Item Quantity</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?= $row['id'] ?></td>
                                                <td>
                                                    <img width="50px" src="<?= $row['product'] ?>" alt="Product image">
                                                </td>
                                                <td><?= $row['description'] ?></td>
                                                <td><?= $row['max_item_qty'] ?></td>
                                                <td><?= $row['available'] ?? null ?></td>
                                                <td>
                            ...
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                ...
                                if ($file['error'] === UPLOAD_ERR_OK) {
                                    ...
                                    if (move_uploaded_file($file['tmp_name'], $uploadPath)) {
                                        ...
                                        $max_item_qty = trim($post['max_item_qty']);
                                        $available = trim($post['available']);
                        ...
                        ?>
                            <form action="" enctype="multipart/form-data" method="POST" class="bg-white p-2 p-md-4" style="border-radius: 20px;">
                                ...
                                <div class="col-12 mt-5 d-flex align-items-center justify-content-end gap-3">
                                    <a href="./inventory.php" class="btn btn-danger btn-lg px-5 text-white" style="border-radius: 20px;">Cancel</a>
                                    <button type="submit" class="btn btn-primary btn-lg px-5 text-white" style="border-radius: 20px;">Save</button>
                                </div>
                            </form>
                        <?php
