...
<body>
    ...
    <div style="
      ...
      " class="w-full d-flex align-items-center justify-content-center flex-column px-3 py-3">
        ...
        <form action="" enctype="multipart/form-data" method="post" class="form p-5 py-3 bg-white rounded col-12 col-lg-4 mb-4 shadow">
            <a href="<?= base_url() ?>"><img class="d-block mx-auto" style="width: 80%; height: 200px; object-fit: cover" src="assets/img/logo.jpg"></a>
            ...
            <div class="container my-3">
                <input autofocus placeholder="Email" value="<?php echo $email ?? null ?>" required type="email" class="form-control form-control-sm input" id="email" name="email">
            </div>
            <div class="container my-3">
